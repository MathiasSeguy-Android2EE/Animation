...
public class CardViewRecyclerViewAdapter extends RecyclerView.Adapter<CardViewRecyclerViewAdapter.ViewHolder>{
     ...
     * Constructor
     **********************************************************/
    public CardViewRecyclerViewAdapter(ArrayList<Human> dataSet, Context ctx){
        humans=dataSet;
     ...
     */
    @Override
    public CardViewRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       // Log.e("RecyclerViewAdapter"," onCreateViewHolder viewtype="+viewType);
        if(viewType==0){
            tNewView=inflater.inflate(R.layout.simple_cardview_item,parent,false);
        }else{
            tNewView=inflater.inflate(R.layout.simple_cardview_item_odd,parent,false);
        }
